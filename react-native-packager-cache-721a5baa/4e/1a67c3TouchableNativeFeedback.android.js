...
'use strict';var _react2=require('react');var _react3=_interopRequireDefault(_react2);var _index=require('./../../../../react-transform-hmr/lib/index.js');var _index2=_interopRequireDefault(_index);var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}var _components={_component:{}};var _reactTransformHmrLibIndexJs2=(0,_index2.default)({filename:'/home/thiago/C\xF3digos/node/viaqui/node_modules/react-native/Libraries/Components/Touchable/TouchableNativeFeedback.android.js',components:_components,locals:[module],imports:[_react3.default]});function _wrapComponent(id){return function(Component){return _reactTransformHmrLibIndexJs2(Component,id);};}
...
var TouchableNativeFeedback=_wrapComponent('_component')(React.createClass({displayName:'TouchableNativeFeedback',
propTypes:_extends({},
...
render:function render(){var _extends2;
...
child.props,(_extends2={},_defineProperty(_extends2,
drawableProp,this.props.background),_defineProperty(_extends2,'accessible',
this.props.accessible!==false),_defineProperty(_extends2,'accessibilityLabel',
this.props.accessibilityLabel),_defineProperty(_extends2,'accessibilityComponentType',
this.props.accessibilityComponentType),_defineProperty(_extends2,'accessibilityTraits',
this.props.accessibilityTraits),_defineProperty(_extends2,'children',
children),_defineProperty(_extends2,'testID',
this.props.testID),_defineProperty(_extends2,'onLayout',
this.props.onLayout),_defineProperty(_extends2,'hitSlop',
this.props.hitSlop),_defineProperty(_extends2,'onStartShouldSetResponder',
this.touchableHandleStartShouldSetResponder),_defineProperty(_extends2,'onResponderTerminationRequest',
this.touchableHandleResponderTerminationRequest),_defineProperty(_extends2,'onResponderGrant',
this.touchableHandleResponderGrant),_defineProperty(_extends2,'onResponderMove',
this._handleResponderMove),_defineProperty(_extends2,'onResponderRelease',
this.touchableHandleResponderRelease),_defineProperty(_extends2,'onResponderTerminate',
this.touchableHandleResponderTerminate),_extends2));
